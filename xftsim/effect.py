...
class AdditiveEffects:
    def __init__(self,
        ...
        # True implies these are effects of standardized variants, False = Raw
        standardized: bool = True,
        # True implies these are effects of variants / sqrt(m_causal)
        scaled: bool = False,
        ):
    ...
    @cached_property
    # multiply against standardized (0,1,2)/sqrt(m) genotypes
    def beta_scaled_standardized_diploid(self):
