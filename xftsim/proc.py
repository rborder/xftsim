...
class LimitMemory(PostProcessor):
    def __init__(self, 
        ...
        assert (n_haplotype_generations==-1) | (n_haplotype_generations>=1), "valid inputs are -1 (keep all generations) OR n>=1 (keep n most recent generations)"
        assert (n_phenotype_generations==-1) | (n_phenotype_generations>=1), "valid inputs are -1 (keep all generations) OR n>=1 (keep n most recent generations)"
